...
public class JobTrigger {
    ...
    public static Trigger getEveryMin(String triggerName, String triggerGroup, DBJobConfigTable jobConfig){
    ...
    public static Trigger getEveryHour(String triggerName, String triggerGroup, DBJobConfigTable jobConfig){
    ...
    public static Trigger getDaily(String triggerName, String triggerGroup, DBJobConfigTable jobConfig){
    ...
    public static Trigger getWeekly(String triggerName, String triggerGroup, DBJobConfigTable jobConfig){
    ...
    public static Trigger getMonthly(String triggerName, String triggerGroup, DBJobConfigTable jobConfig){
    ...
    public static Trigger getYearly(String triggerName, String triggerGroup, DBJobConfigTable jobConfig){
